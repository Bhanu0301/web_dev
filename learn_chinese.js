...
function handle_addCartItem(){
    ...
    for(let i = 0;i<11;i++){
        ...
        if(title=="Paneer-fried Rice"){
            var imgSrc = document.getElementsByClassName("food-items-image")[8].src;
            break;
        }
        if(title=="Paneer Fried Noodles"){
            var imgSrc = document.getElementsByClassName("food-items-image")[9].src;
            break;
        }
        if(title=="Paneer-Manchurian"){
            var imgSrc = document.getElementsByClassName("food-items-image")[10].src;
            break;
        }
